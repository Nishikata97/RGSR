...
parser.add_argument('--dataset', default='Movies_and_TV_5', help='Pet_Supplies_5/ CDs_and_Vinyl_5/ Movies_and_TV_5/ Tools_and_Home_Improvement_5/ Toys_and_Games_5/ Video_Games_5/ Yelp')
...
parser.add_argument('--dropout_inter', type=float, default=0, help='Dropout rate.')
parser.add_argument('--dropout_text', type=float, default=0, help='Dropout rate.')
...
parser.add_argument('--beta', type=float, default=0.0002, help='The weight for batch_sess_loss.')
...
def main():
    ...
    for epoch in range(opt.epoch):
        print('-------------------------------------------------------')
        print('epoch: ', epoch)
        hit_20, mrr_20, hit_10, mrr_10, hit_5, mrr_5 = train_test(opt, model, train_data, test_data)
